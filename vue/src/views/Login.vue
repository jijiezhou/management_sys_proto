    ...
    <div style="display: flex; background-color: white; width: 50%; border-radius: 5px; overflow: hidden">
      ...
      <div style="flex: 1; display: flex; align-items: center; justify-content: center">
        <el-form :model="user" style="width: 80%" :rules="rules" ref="loginRef">
          <div style="font-size: 20px; font-weight: bold; text-align: center; margin-bottom: 20px">Welcome Management System</div>
          ...
          <el-form-item prop="code">
            <div style="display: flex">
              <el-input placeholder="please enter validate code" prefix-icon="el-icon-circle-check" size="medium" style="flex: 1" v-model="user.code"></el-input>
